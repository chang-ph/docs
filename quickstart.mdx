...
aCoinfer consists of three parts:
...
1. Open this URL with you browser: `https://coinfer/bayes/main/`.
...
You can also use the experiment ID to construct the URL as follows to directly open the experiment detail page: `https://coinfer.ai/bayes/main/#/platform/experiment/[experiment_id]`
