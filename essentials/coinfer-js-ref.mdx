...
```typescript
createModelFromGithubGist(id: string, modelName: string): Promise<IGithubCreatedRes>;
```
...
```typescript
createModelFromGithubRepo(id: string, branch: string, modelName: string): Promise<IGithubCreatedRes>;
```
...
createModelFromGithubGist(id, modelName)
...
createModelFromGithubRepo(id, branch, modelName)
