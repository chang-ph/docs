...
title: "Reference"
hide_title: true
update_time: 2025-3-21 14:48:38
...
```typescript
createModelFromGithubGist(id: string): Promise<IGithubCreatedRes>;
```
...
```typescript
createModelFromGithubRepo(id: string, branch: string): Promise<IGithubCreatedRes>;
```
...
createModelFromGithubRepo(id, branch)
