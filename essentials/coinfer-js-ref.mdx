...
## Coinfer.createModelFromGithub() method

Create a model from GitHub repository/gist.

**Signature:**

```typescript
createModelFromGithub(repo: string, branch: string, type: 'repo' | 'gist'): Promise<IGithubCreatedRes>;
```
...
createModelFromGithub(repo, branch, type)
